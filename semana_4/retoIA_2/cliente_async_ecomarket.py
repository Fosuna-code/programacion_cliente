...
# Static path to semana2
SEMANA2_PATH = os.path.abspath(
    os.path.join(os.path.dirname(__file__), "..", "..", "semana_2")
)

# Importing validators from semana2
sys.path.insert(0, os.path.join(SEMANA2_PATH, "Aplica", "retoIA_4"))
from validadores import validar_producto, validar_lista_productos

sys.path.insert(0, os.path.join(SEMANA2_PATH, "Aplica", "RetoIA_5"))
...
async def cargar_dashboard():
    ...
    async with aiohttp.ClientSession(timeout=TIMEOUT) as session:
        ...
        return {"exitosos": exitosos, "errores": errores, "tiempo_ms": tiempo_total}
...
def cargar_dashboard_sincrono():
    ...
    """
    sys.path.insert(0, os.path.join(SEMANA2_PATH, "Aplica", "RetoIA_3"))
