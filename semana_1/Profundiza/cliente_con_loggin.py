...
from custom_logging  import observability_logger
...
class APIservices:
    ...
    def listar_productos(self):
        ...
        return response  # Return response object for observability_logger
...
if __name__ == "__main__":
    ...
    response = api.obtener_producto(1)
